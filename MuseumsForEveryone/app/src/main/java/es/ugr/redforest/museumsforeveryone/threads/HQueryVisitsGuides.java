            ...
            try {
                if(resultado!=null) {
                    ...
                    if (!res.isNull("visits")) {
                        JSONArray contentType = res.getJSONArray("visits");
            ...
            recyclerGuidedVisit.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
                ...
                public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
                    ...
                    if(child!=null && mGestureDetector.onTouchEvent(e)) {
                        ...
                        ActivityArtworkListIntent.putExtra("id", guidedVisits.get(recyclerGuidedVisit.getChildAdapterPosition(child)).getId());
